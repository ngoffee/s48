...
** Flat result (times in ms): 
 ...
 61.66%   1498   1498    2k    37+51       17   c
  25.0%   2430    608   10k      436        6   b
 13.33%   2430    324   10k      442        5   a
   0.0%   2430      0    0k        1     2430   main
...
The formatting of the output is based on the output of gprof.
...
\item \code{calls}:
	...
	optionally appended "+" to former number (see \code{c}).
\item \code{ms/call}:

...
(define-interface profiler-internal-interface
  (export profile-count
	  get-active-profile-data
	  set-active-profile-data!
	  set-first-call?!
	  profinfo-id
	
	  really-make-empty-profile-data
	  profile-data-templates
	  profile-data-root
	  profile-data-samples
	  profile-data-interrupttime
	  profile-data-memoryuse
	  profile-data-gcruns
	  profile-data-cycles
	  profile-data-starttime
	  profile-data-endtime
	  set-profile-data-interrupttime!
	  set-profile-data-templates!
	  set-profile-data-samples!
	  set-profile-data-starttime!
	  set-profile-data-root!
	  set-profile-data-endtime!
	  set-profile-data-gcruns!
	  set-profile-data-cycles!
	  ...
	  make-callerinfo
	  callerinfo-calls
	  callerinfo-set-tself!
	  callerinfo-set-tchild!
	  callerinfo-set-calls!
	  ))

...
echo (define-test-suite all-tests (compiler-tests big-tests misc-tests tcp-sockets-tests sort-tests r6rs-tests cml-tests portable-srfi-tests)) >> check.input
